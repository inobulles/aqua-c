...
AQUA_C_FN device_t wgpu_device = NO_DEVICE;
...
AQUA_C_FN WGPUProc wgpuGetProcAddress(WGPUDevice device, char const * procName) {
	struct {
		WGPUDevice device;
		char const * procName;
	} __attribute__((packed)) const args = {
...
AQUA_C_FN size_t wgpuAdapterEnumerateFeatures(WGPUAdapter adapter, WGPUFeatureName * features) {
	struct {
		WGPUAdapter adapter;
...
AQUA_C_FN void wgpuComputePassEncoderDispatchWorkgroups(WGPUComputePassEncoder computePassEncoder, uint32_t workgroupCountX, uint32_t workgroupCountY, uint32_t workgroupCountZ) {
	struct {
		WGPUComputePassEncoder computePassEncoder;
...
AQUA_C_FN void wgpuComputePassEncoderDispatchWorkgroupsIndirect(WGPUComputePassEncoder computePassEncoder, WGPUBuffer indirectBuffer, uint64_t indirectOffset) {
	struct {
		WGPUComputePassEncoder computePassEncoder;
...
AQUA_C_FN void wgpuComputePassEncoderEnd(WGPUComputePassEncoder computePassEncoder) {
	struct {
		WGPUComputePassEncoder computePassEncoder;
	} __attribute__((packed)) const args = {
		.computePassEncoder = computePassEncoder,
...
AQUA_C_FN WGPUTextureFormat wgpuSurfaceGetPreferredFormat(WGPUSurface surface, WGPUAdapter adapter) {
	struct {
		WGPUSurface surface;
		WGPUAdapter adapter;
	} __attribute__((packed)) const args = {
...
AQUA_C_FN WGPUTextureView wgpuTextureCreateView(WGPUTexture texture, WGPU_NULLABLE WGPUTextureViewDescriptor const * descriptor) {
	struct {
		WGPUTexture texture;
...
AQUA_C_FN void wgpuTextureDestroy(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN uint32_t wgpuTextureGetDepthOrArrayLayers(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN WGPUTextureDimension wgpuTextureGetDimension(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN WGPUTextureFormat wgpuTextureGetFormat(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN uint32_t wgpuTextureGetHeight(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN uint32_t wgpuTextureGetMipLevelCount(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN uint32_t wgpuTextureGetSampleCount(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN WGPUTextureUsageFlags wgpuTextureGetUsage(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN uint32_t wgpuTextureGetWidth(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN void wgpuTextureSetLabel(WGPUTexture texture, char const * label) {
	struct {
		WGPUTexture texture;
		char const * label;
	} __attribute__((packed)) const args = {
...
AQUA_C_FN void wgpuTextureReference(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN void wgpuTextureRelease(WGPUTexture texture) {
	struct {
		WGPUTexture texture;
	} __attribute__((packed)) const args = {
		.texture = texture,
...
AQUA_C_FN void wgpuTextureViewSetLabel(WGPUTextureView textureView, char const * label) {
	struct {
...
AQUA_C_FN void wgpuTextureViewReference(WGPUTextureView textureView) {
	struct {
		WGPUTextureView textureView;
	} __attribute__((packed)) const args = {
		.textureView = textureView,
...
AQUA_C_FN void wgpuTextureViewRelease(WGPUTextureView textureView) {
	struct {
		WGPUTextureView textureView;
	} __attribute__((packed)) const args = {
		.textureView = textureView,
